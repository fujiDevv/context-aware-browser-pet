...
*   **Install Size:** The Chrome Web Store download is ~6 MB compressed (~22–25 MB unpacked in Chrome details). Lite Mode is the default; DistilBERT model weights are not fetched until you explicitly enable Brain Upgrade in Settings.
